...
//
// example calls:
// [GlobalMethods getLocalizedValueForKey:@"Text to localize",@"Alternative text, in case hte other is not find");
...
- (void)setLanguage:(NSString *)langID {
	NSString *path = [[NSBundle mainBundle] pathForResource:langID ofType:@"lproj"];
    ...
    [superModel.userDefaults setObject:langID forKey:keySelectedLanguageId];
}
